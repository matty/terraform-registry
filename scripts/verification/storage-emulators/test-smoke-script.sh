...
SMOKE="$ROOT/scripts/verification/phase-1-storage-emulator-terraform-smoke.sh"
...
grep -Fq 'TF_REG_AdminEmails: dev@localhost' "$ROOT/scripts/verification/storage-emulators/compose.yaml"
